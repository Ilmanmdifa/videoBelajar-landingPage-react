...
const HomeMain = () => {
  return (
    <main className="h-full flex items-center md:px-[120px] md:py-[64px] gap-6 flex-col px-[20px] py-[28px] bg-[#fff7d7cc]">
      <section className="bg-hero w-[320px] h-[400px] md:w-[1200px]  rounded-[10px] shadow-md ">
...
//todo finish for desktop and please focus
